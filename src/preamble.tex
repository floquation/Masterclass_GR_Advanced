...
\newcommand{\lenitem}[2][.7\linewidth]{\parbox[t]{#1}{\strut #2\strut}} % Wrap text in a fixed-size parbox environment.
...
\draw[step=.5cm,green,thin] (C) grid (D);     % Use 0.5cm will be easier to find coordinates (xx,yy)
\end{tikzpicture}
}