...
\pause%5
  \item Vergelijkingen bij \tiYEquals\, zijn ook tekstregels:
		...
		\inlineticalc{\qt X\sq\qt\>Y\sub{1}} verandert de \tifonttxt{Y\sub{1}} grafiek naar de functie $y=x^2$.
...
\begin{itemize}
  \item<2-> \textbf{Lists.} Een collectie getallen.
  ...
  \item<3-> \textbf{Matrix.} Een soort 2D list. Geen middelbare school wiskunde.
  \item<4-> \textbf{Boolean.} ``Juist'' of ``Onjuist''
\end{itemize}
...
Andere datatypen verdienen ook een korte benoeming:
\begin{itemize}
  \item<2-> \textbf{Picture.} Je kunt met de functies in het \tiDRAW-menu tekeningen op je rekenmachine maken.
  		Deze kun je in \tifonttxt{Pic\#} variabelen opslaan.
  \item<3-> \textbf{Graph.} Je kunt alle functies die je bij \tiYEquals\, hebt staan opslaan in een \tifonttxt{GDB\#} variabele
  		(GDB = Graph Database).
