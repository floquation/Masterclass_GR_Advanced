...
\begin{frame}
\frametitle{Use \tifonttxt{Ans}}

\begin{itemize}
  \item<1-> In plaats van variabelen door te pasen\ldots
  \item<2-> kun je ook \tifonttxt{Ans} gebruiken!
  \item<3-> Voordeel: Je overschrijft variabelen niet onnodig.
\end{itemize}
\visible<4->{%
\begin{itemize}
  \item<4-> Zie ook: http://tibasicdev.wikidot.com/subprograms
\end{itemize}%
}
